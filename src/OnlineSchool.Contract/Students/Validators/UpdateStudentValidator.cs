...
namespace OnlineSchool.Contract.Students.Validators
{
    ...
    {
        public UpdateStudentValidator(IStringLocalizer<CreateStudentModel> localizer)
        {
            ...
            RuleFor(n => n.Description).NotNull().MaximumLength(500).WithMessage(n => localizer[ValidationSharedResources.DescriptionLength]);
