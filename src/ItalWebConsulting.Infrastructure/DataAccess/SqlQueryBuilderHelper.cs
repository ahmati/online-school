...
{
    public static class SqlQueryBuilderHelper
    {
        ...
        public static GetSqlSelectByColumnnsOutput GetSqlSelectByColumnns(string tableName, IDictionary<string, object> columnsParams)
        {
            var output = new GetSqlSelectByColumnnsOutput();
            var whereClausole = new StringBuilder();
