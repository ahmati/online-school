...
namespace OnlineSchool.Domain.Migrations
{
    ...
    [Migration("20210923080145__AddColumn_BookedCourse_MeetingEmailReminder")]
    partial class _AddColumn_BookedCourse_MeetingEmailReminder
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineSchool.Domain.OnlineSchoolDB.EF.BookedCourse", b =>
                {
                    ...
                    b.Property<bool>("MeetingEmailReminder")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
            ...
            modelBuilder.Entity("OnlineSchool.Domain.OnlineSchoolDB.EF.BookedSpotMeeting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("SpotMeetingId")
                        .HasName("SpotMeetingId_Index");

                    b.HasIndex("UserId")
                        .HasName("userId_Index");

                    b.ToTable("BookedSpotMeeting");
                });
            ...
            modelBuilder.Entity("OnlineSchool.Domain.OnlineSchoolDB.EF.Session", b =>
                {
                    ...
                    b.Property<string>("MeetingSipAddress")
                        .IsRequired()
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("OnlineSchool.Domain.OnlineSchoolDB.EF.SpotMeeting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("IsRecursiveSpotMeeting")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValueSql("0");
                    ...
                    b.ToTable("SpotMeeting");
                });

            modelBuilder.Entity("OnlineSchool.Domain.OnlineSchoolDB.EF.SpotMeetingMaterial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("SpotMeetingId", "MaterialId")
                        .IsUnique()
                        .HasName("lessonId_materialId_Index");

                    b.ToTable("SpotMeetingMaterial");
                });

            modelBuilder.Entity("OnlineSchool.Domain.OnlineSchoolDB.EF.SpotMeetingTeacher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("SpotMeetingId", "TeacherId")
                        .IsUnique()
                        .HasName("lessonId_teacherId_Index");

                    b.ToTable("SpotMeetingTeacher");
                });
            ...
            modelBuilder.Entity("OnlineSchool.Domain.OnlineSchoolDB.EF.WebexGuestIssuer", b =>
                {
                    b.Property<string>("Id")
                        .IsRequired()
                        .HasColumnType("nvarchar(300)");
                    ...
                    b.ToTable("WebexGuestIssuer");
                });

            modelBuilder.Entity("OnlineSchool.Domain.OnlineSchoolDB.EF.WebexIntegration", b =>
                {
            ...
            modelBuilder.Entity("OnlineSchool.Domain.OnlineSchoolDB.EF.BookedSpotMeeting", b =>
                {
                    b.HasOne("OnlineSchool.Domain.OnlineSchoolDB.EF.SpotMeeting", "SpotMeeting")
                        .WithMany("BookedSpotMeetings")
                        .HasForeignKey("SpotMeetingId")
